...
local EXACT_EN = {
    ...
    ["โอสถหล่อเลี้ยงจิต Xaou"]="Xaou Mind-Nurturing Pill",
    ["เพิ่มสภาวะจิต 200 เป็นเวลา 5 วันเกม ใช้ได้กับตัวละครทั่วไป"]="Increases Mental State by 200 for 5 in-game days. Usable by any character.",
