...
local EXACT_EN = {
    ...
    ["โอสถยกระดับสภาวะจิต Xaou"]="Xaou Divine Mind Ascension Pill",
    ["ซื้อแล้วใช้กับ NPC ที่เลือกทันที เพิ่มระดับสภาวะจิตสายเทพ 1 ระดับ ใช้ได้เฉพาะผู้ฝึกวิชาสายเทพ"]="Applied immediately to the selected NPC. Raises Divine Mind State by 1 level. Only works on divine cultivators.",
...
local REPLACE_EN = {
    ...
    {"ใช้กับ NPC ที่เลือกทันที", "Applied immediately to the selected NPC."},
    {"ใช้โอสถสำเร็จ ระดับสภาวะจิตของ NPC เพิ่มขึ้น 1 ระดับ", "Pill used successfully. The NPC's Divine Mind State increased by 1 level."},
    {"NPC ที่เลือกยังไม่ได้ฝึกวิชาสายเทพ", "The selected NPC is not cultivating a divine art."},
    {"ระดับสภาวะจิตไม่เปลี่ยน อาจถึงระดับสูงสุดแล้ว", "Divine Mind State did not change. It may already be at the maximum level."},
    {"เกมไม่ยอมเพิ่มระดับสภาวะจิต", "The game rejected the Divine Mind State level increase."},
    ...
    {"กระเป๋า", "Xaou 009 Backpack"}, {"▶ ในกระเป๋า", "▶ Backpack"}, {"ในกระเป๋า", "Backpack"},
    ...
    {"เช็กอินรายวัน", "Xaou 009 Daily Login"}, {"รับรางวัลวันนี้", "Claim Today's Reward"},
